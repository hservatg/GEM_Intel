...
!$omp target enter data map(alloc:gxdgy,dydr,dbdr,dbdth,jacob)
...
!$omp target enter data map(alloc:xn0i,xn0e,xn0c,xn0b,xn0ip,xn0ep,&
!$omp xn0bp)
...
!$omp target enter data map(alloc:e1gx,e1gy,e2gx,e2gy,bdge1gx,bdge1gy,&
!$omp bdge2gx,bdge2gy)
...
!$omp target enter data map(alloc:curvbz,srbr,srbz,thbr,thbz,prsrbr,&
!$omp prsrbz,pthsrbr,pthsrbz,bdcrvb)
...
! Code was translated using: /nfs/site/home/tkloeffe/TCE/intel-application-migration-tool-for-openacc-to-openmp/src/intel-application-migration-tool-for-openacc-to-openmp gem_equil.F90
